...
public class GlobalErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handlerException(ModelNotFoundException ex, WebRequest req) {
    ...
    public ResponseEntity<CustomErrorResponse> handlerSQLException(ModelNotFoundException ex, WebRequest req) {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest req) {
        ...
        CustomErrorResponse badError = new CustomErrorResponse(LocalDateTime.now(), message, req.getDescription(false));
        return new ResponseEntity<>(badError, HttpStatus.BAD_REQUEST);
    }
